...
struct SampleEdge { int u, v, w; };

static string sample_city_names[10] = {
    "Central Depot", "Main Street", "Park Avenue", "Industrial Area", 
    "Residential North", "Residential South", "Market District", 
    "Commercial Hub", "University Area", "Recycling Center"
};

static SampleEdge sample_edges[12] = {
    {0, 1, 2}, {0, 2, 3}, {1, 3, 4}, {1, 4, 2},
    {2, 5, 3}, {2, 6, 5}, {3, 7, 1}, {4, 7, 3},
    {5, 8, 2}, {6, 9, 4}, {7, 8, 6}, {8, 9, 3}
};
